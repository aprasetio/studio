...
import { Plus, Trash2, CalendarDays, UserPlus, Image as ImageIcon, Download } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col items-center p-6 md:p-12 max-w-7xl mx-auto w-full gap-8">
      ...
      <div ref={scheduleRef} className="w-full space-y-8 p-2">
        ...
        <div className="text-right text-xs text-muted-foreground mt-4 font-medium opacity-70 tracking-widest uppercase">
          versokit.com
        </div>
      </div>
