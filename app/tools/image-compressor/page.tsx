...
const UI_TEXT: Record<string, any> = {
  ...
  id: {
    title: "Kompres Foto",
    upload: "Unggah",
    click_to_choose: "Klik untuk Pilih Foto",
    supports: "Mendukung JPG, PNG, WebP",
    original_size: "Asli",
    compressed_size: "Hasil",
    quality: "Kualitas",
    compress: "Kompres Sekarang",
  ...
  de: {
    ...
    upload: "Hochladen",
    click_to_choose: "Bild auswählen",
    supports: "Unterstützt JPG, PNG, WebP",
    original_size: "Original",
    compressed_size: "Komprimiert",
    quality: "Qualität",
  ...
  es: {
    ...
    upload: "Subir",
    click_to_choose: "Seleccionar imagen",
  ...
  pt: {
    ...
    upload: "Carregar",
    click_to_choose: "Escolher imagem",
  ...
  fr: {
    ...
    upload: "Télécharger",
    click_to_choose: "Choisir une image",
    supports: "Supporte JPG, PNG, WebP",
    original_size: "Original",
    compressed_size: "Compressé",
    quality: "Qualité",
    compress: "Compresser",
  ...
  it: {
    ...
    upload: "Carica",
    click_to_choose: "Seleziona immagine",
    supports: "Supporta JPG, PNG, WebP",
    original_size: "Originale",
    compressed_size: "Compresso",
    quality: "Qualità",
    compress: "Comprimi",
