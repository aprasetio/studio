...
export const TOOL_ARTICLES: ArticleCollection = {
  ...
  "image-compressor": {
    en: {
      title: "Compress Images Online Without Quality Loss",
      sections: [
        {
          title: "How Image Compression Works",
          content: "Image compression reduces the file size of your photos (JPG, PNG, WebP) by removing unnecessary data or using smart algorithms to balance quality and size. <b>Lossy compression</b> provides the smallest file sizes, while our tool allows you to adjust the quality to find the perfect balance for your website or storage needs."
        },
        {
          title: "100% Private: Browser-Based Processing",
          content: "Privacy is our priority. Unlike other online compressors, VersoKit processes your images <b>locally in your browser</b>. Your photos are never uploaded to a cloud server, ensuring your personal and business images remain completely private and secure on your own device."
        }
      ]
    },
    id: {
      title: "Kompres Foto Online: Cepat & Aman",
      sections: [
        {
          title: "Cara Kerja Kompresi Gambar",
          content: "Kompresi gambar mengecilkan ukuran file foto Anda (JPG, PNG, WebP) agar lebih ringan untuk dikirim atau di-upload. Dengan mengurangi data yang tidak perlu, website Anda akan loading lebih cepat tanpa mengorbankan kualitas visual secara signifikan."
        },
        {
          title: "Privasi Total di Perangkat Anda",
          content: "Fitur unggulan VersoKit adalah pemrosesan <b>Client-side</b>. Artinya, foto Anda dikompres langsung di HP atau Laptop Anda. Tidak ada data yang dikirim ke server kami, sehingga privasi foto pribadi maupun bisnis Anda terjamin 100%."
        }
      ]
    },
    de: {
      title: "Bilder online komprimieren ohne Qualitätsverlust",
      sections: [
        {
          title: "Datenschutz an erster Stelle",
          content: "Ihre Bilder werden direkt in Ihrem Browser verarbeitet. Nichts wird auf unsere Server hochgeladen."
        }
      ]
    },
    es: {
      title: "Comprimir imágenes online sin perder calidad",
      sections: [
        {
          title: "Privacidad Garantizada",
          content: "Tus fotos se procesan localmente en tu navegador. Nunca se suben a la nube."
        }
      ]
    },
    fr: {
      title: "Compresser des images en ligne sans perte de qualité",
      sections: [
        {
          title: "Respect de la vie privée",
          content: "Vos images sont traitées localement dans votre navigateur. Aucun fichier n'est envoyé sur nos serveurs."
        }
      ]
    },
    pt: {
      title: "Comprimir imagens online sem perda de qualidade",
      sections: [
        {
          title: "Privacidade Total",
          content: "Suas fotos são processadas localmente no seu navegador. Elas nunca são enviadas para um servidor."
        }
      ]
    },
    it: {
      title: "Comprimi immagini online senza perdita di qualità",
      sections: [
        {
          title: "Massima Privacy",
          content: "Le tue immagini vengono elaborate localmente nel tuo browser. Nessun file viene caricato sui nostri server."
        }
      ]
    }
  }
