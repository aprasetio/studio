...
export const SEO_DATA: SeoCollection = {
  ...
  futsal: {
    ...
    es: {
      ...
      description: "Un marcador digital simple y eficaz para tus partidos de fútbol sala.",
    ...
    pt: {
      ...
      description: "Um placar digital simples e eficaz para seus jogos de futsal.",
    ...
    de: {
      ...
      description: "Eine einfache und effektive digitale Anzeigetafel für Ihre Futsal-Spiele.",
    ...
    it: {
      ...
      description: "Un tabellone segnapunti digitale semplice ed efficace per le tue partite di futsal.",
  ...
  lineup: {
    en: {
      ...
      description: "Create and visualize your football team formation and strategy.",
    ...
    id: {
      ...
      description: "Buat dan visualisasikan formasi serta strategi tim sepak bola Anda.",
    ...
    es: {
      ...
      description: "Crea y visualiza la formación y estrategia de tu equipo de fútbol.",
    ...
    pt: {
      ...
      description: "Crie e visualize a formação e estratégia do seu time de futebol.",
    ...
    de: {
      ...
      description: "Erstellen und visualisieren Sie die Formation und Strategie Ihrer Fußballmannschaft.",
    ...
    fr: {
      ...
      description: "Créez et visualisez la formation et la stratégie de votre équipe de football.",
    ...
    it: {
      ...
      description: "Crea e visualizza la formazione e la strategia della tua squadra di calcio.",
  ...
  scoreboard: {
    en: {
      ...
      description: "Versatile scoreboard for Volleyball, Badminton, and Table Tennis.",
    ...
    es: {
      ...
      description: "Marcador versátil para Voleibol, Bádminton y Tenis de Mesa.",
    ...
    pt: {
      ...
      description: "Placar versátil para Vôlei, Badminton e Tênis de Mesa.",
    ...
    de: {
      ...
      description: "Vielseitiger Punktezähler für Volleyball, Badminton und Tischtennis.",
    ...
    it: {
      ...
      description: "Tabellone segnapunti versatile per pallavolo, badminton e tennis da tavolo.",
  ...
  tournament: {
    en: {
      ...
      description: "Instant Round Robin schedule generator for social leagues and tournaments.",
    ...
    es: {
      ...
      description: "Generador instantáneo de calendarios Round Robin para ligas y torneos sociales.",
    ...
    pt: {
      ...
      description: "Gerador instantâneo de tabelas Round Robin para ligas e torneios sociais.",
    ...
    de: {
      ...
      description: "Sofortiger Round-Robin-Zeitplangenerator für soziale Ligen und Turniere.",
    ...
    fr: {
      ...
      description: "Générateur instantané de calendrier Round Robin pour les ligues et tournois sociaux.",
    ...
    it: {
      ...
      description: "Generatore istantaneo di calendari all'italiana per campionati e tornei amatoriali.",
  ...
  inventory: {
    en: {
      ...
      description: "Track sports equipment and business stock levels digitally.",
    ...
    id: {
      ...
      description: "Pantau stok peralatan olahraga dan stok bisnis Anda secara digital.",
    ...
    es: {
      ...
      description: "Controla digitalmente el equipo deportivo y los niveles de stock del negocio.",
    ...
    pt: {
      ...
      description: "Acompanhe digitalmente equipamentos esportivos e níveis de estoque comercial.",
    ...
    de: {
      ...
      description: "Verfolgen Sie Sportausrüstung und Lagerbestände digital.",
    ...
    fr: {
      ...
      description: "Suivez numériquement les équipements sportifs et les niveaux de stock de l'entreprise.",
    ...
    it: {
      ...
      description: "Monitora digitalmente le attrezzature sportive e i livelli di stock aziendali.",
  ...
  kanban: {
    en: {
      title: "Kanban Board",
      description: "Manage team tasks and plans with a simple visual kanban board.",
    ...
    id: {
      title: "Papan Kanban",
      description: "Kelola tugas dan rencana tim dengan papan kanban visual yang sederhana.",
    ...
    es: {
      ...
      description: "Gestiona tareas y planes de equipo con un tablero kanban visual simple.",
    ...
    pt: {
      title: "Quadro Kanban",
      description: "Gerencie tarefas e planos de equipe com um quadro kanban visual simples.",
    ...
    fr: {
      ...
      description: "Gérez les tâches et les plans de l'équipe avec un tableau kanban visuel simple.",
    ...
    it: {
      ...
      description: "Gestisci le attività e i piani del team con una semplice lavagna kanban visiva.",
  ...
  calculator: {
    en: {
      ...
      description: "Calculate paint, tile needs and estimate material costs easily.",
    ...
    id: {
      ...
      description: "Hitung kebutuhan cat, keramik, dan estimasi biaya material dengan mudah.",
    ...
    es: {
      ...
      description: "Calcula necesidades de pintura, azulejos y estima costos de materiales fácilmente.",
  ...
  invoice: {
    en: {
      title: "Invoice Maker",
      description: "Create professional invoices and save them as PDF for your clients.",
    ...
    es: {
      ...
      description: "Crea facturas profesionales y guárdalas como PDF para tus clientes.",
  ...
  shift: {
    en: {
      title: "Shift Roster",
      description: "Manage your team's weekly work schedule with a visual shift system.",
    ...
    es: {
      ...
      description: "Gestiona el horario de trabajo semanal de tu equipo con un sistema de turnos visual.",
    ...
    pt: {
      ...
      description: "Gerencie a escala de trabalho semanal da sua equipe com um sistema visual.",
  ...
  "pdf-merge": {
    en: {
      title: "PDF Merger",
      description: "Merge multiple PDF files into one document offline.",
    ...
    es: {
      title: "Unir PDF",
      description: "Combina varios archivos PDF en un solo documento sin conexión.",
    ...
    pt: {
      title: "Juntar PDF",
      description: "Mescle vários arquivos PDF em um único documento offline.",
    ...
    de: {
      title: "PDF Verbinden",
      description: "Verbinden Sie mehrere PDF-Dateien offline zu einem Dokument.",
    ...
    it: {
      title: "Unisci PDF",
      description: "Unisci più file PDF in un unico documento offline.",
  ...
  "image-to-pdf": {
    en: {
      title: "Image to PDF",
      description: "Convert your JPG/PNG image collection into a PDF document.",
    ...
    id: {
      ...
      faq: [{ q: "Format?", a: "Mendukung JPG and PNG." }]
    },
    es: {
      title: "Imagen a PDF",
      description: "Convierte tu colección de imágenes JPG/PNG en un documento PDF.",
    ...
    pt: {
      ...
      description: "Converta sua coleção de imagens JPG/PNG em un documento PDF.",
    ...
    de: {
      title: "Bild zu PDF",
      description: "Konvertieren Sie Ihre JPG/PNG-Bildersammlung in ein PDF-Dokument.",
    ...
    fr: {
      title: "Image en PDF",
      description: "Convertissez votre collection d'images JPG/PNG en un document PDF.",
    ...
    it: {
      ...
      description: "Converti la tua collezione di immagini JPG/PNG in un documento PDF.",
  ...
  "image-compressor": {
    en: {
      ...
      description: "Compress image file size directly in the browser without uploading.",
  ...
  "split-bill": {
    en: {
      title: "Split Bill",
      description: "Calculate meal sharing or team costs with details for WA.",
    ...
    pt: {
      title: "Dividir Conta",
      description: "Calcule a divisão de refeições ou custos de equipe com detalhes para WA.",
    ...
    de: {
      ...
      description: "Berechnen Sie Essensfreigaben oder Teamkosten mit Details für WA.",
    ...
    fr: {
      ...
      description: "Calculez le partage des repas ou les coûts d'équipe avec des détails pour WA.",
    ...
    it: {
      title: "Dividi Conto",
      description: "Calcola la condivisione dei pasti o i costi del team con i dettagli per WA.",
  ...
  "csv-helper": {
    en: {
      title: "CSV Cleaner",
      description: "Clean and process your CSV files locally without uploading.",
      steps: ["Upload CSV.", "Preview data.", "Remove duplicates.", "Download cleaned CSV."],
      article: "Process large CSV datasets directly in your browser. Privacy is 100% guaranteed.",
      faq: [{ q: "Data limit?", a: "Limited by your browser's memory, usually up to 50MB." }]
    },
    id: {
      title: "Pembersih CSV",
      description: "Bersihkan dan proses file CSV Anda secara lokal tanpa upload.",
      steps: ["Upload CSV.", "Pratinjau data.", "Hapus duplikat.", "Unduh CSV bersih."],
      article: "Proses dataset CSV besar langsung di browser Anda. Privasi terjamin 100%.",
      faq: [{ q: "Batas data?", a: "Dibatasi oleh memori browser Anda, biasanya hingga 50MB." }]
    },
    es: {
      title: "Limpiador CSV",
      description: "Limpia y procesa tus archivos CSV localmente sin subirlos.",
      steps: ["Subir CSV.", "Vista previa.", "Quitar duplicados.", "Descargar CSV limpio."],
      article: "Procesa grandes conjuntos de datos CSV directamente en tu navegador.",
      faq: [{ q: "¿Es seguro?", a: "Sí, los datos nunca se envían al servidor." }]
    },
    pt: {
      title: "Limpador de CSV",
      description: "Limpe e processe seus arquivos CSV localmente sem fazer upload.",
      steps: ["Carregar CSV.", "Ver dados.", "Remover duplicatas.", "Baixar CSV limpo."],
      article: "Processe grandes conjuntos de datos CSV diretamente no seu navegador.",
      faq: [{ q: "Privacidade?", a: "Seus dados permanecem locais o tempo todo." }]
    },
    de: {
      title: "CSV-Reiniger",
    ...
    it: {
      title: "Pulizia CSV",
      description: "Pulisci e elabora i tuoi file CSV localmente senza caricarli.",
      steps: ["Carica CSV.", "Anteprima.", "Rimuovi duplicati.", "Scarica CSV pulito."],
      article: "Elora dataset CSV di grandi dimensioni direttamente nel browser.",
      faq: [{ q: "Sicuro?", a: "Assolutamente, i dati non lasciano il PC." }]
    }
  }
};
