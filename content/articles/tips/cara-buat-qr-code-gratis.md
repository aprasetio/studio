---
title: "Cara Buat QR Code Gratis untuk Link, WiFi, dan Kontak — Download PNG & SVG"
description: "Panduan lengkap membuat QR code gratis di browser — untuk URL, password WiFi, atau data kontak. Download hasil dalam format PNG atau SVG tanpa registrasi."
category: "tips"
...
1. **Buka tool** di `/tools/qr-generator` — tidak perlu login atau buat akun
2. **Pilih jenis QR code** yang ingin dibuat: URL, WiFi, atau Kontak
...
4. **Preview QR code** — tampil langsung saat data diketik
5. **Pilih format unduhan**: PNG (untuk keperluan umum) atau SVG (untuk cetak berkualitas tinggi)
6. **Download** — file siap digunakan
...
- **WhatsApp Chat langsung**: QR code yang link ke `wa.me/62812345` agar pembeli bisa langsung chat tanpa save nomor dulu
- **Invoice atau struk**: QR code yang link ke riwayat transaksi atau portal layanan pelanggan
