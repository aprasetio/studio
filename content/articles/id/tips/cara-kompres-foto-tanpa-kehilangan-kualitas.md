---
title: "Cara Kompres Foto Tanpa Kehilangan Kualitas — 100% di Browser, Gratis"
description: "Panduan kompres foto online tanpa upload ke server — kurangi ukuran file foto hingga 80% langsung di browser dengan aman, cepat, dan gratis."
category: "tips"
...
1. **Buka tool** di `/tools/image-compressor` — langsung bisa dipakai tanpa akun
2. **Upload foto** — drag & drop atau klik area upload. Mendukung JPG, PNG, dan WebP
3. **Pilih level kompresi** — geser slider atau pilih preset (Low / Medium / High)
4. **Lihat preview perbandingan** — tool menampilkan foto asli vs hasil kompresi side-by-side dengan info ukuran file masing-masing
5. **Bandingkan ukuran dan kualitas** — pastikan penurunan kualitas masih dalam batas yang bisa diterima
6. **Download** — simpan foto terkompresi. Nama file otomatis diberi suffix `_compressed`
...
- Dimensi yang disarankan: 800×800 px atau 1200×1200 px (gunakan [tool resize foto](/article/tips/cara-ubah-ukuran-foto-online) dulu sebelum kompres)
...
- Kompres setelah [crop ke rasio yang tepat](/article/tips/cara-crop-foto-online-gratis) untuk menghindari white space yang tidak perlu
