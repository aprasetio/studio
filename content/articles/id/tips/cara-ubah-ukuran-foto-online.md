---
title: "Cara Ubah Ukuran Foto Online ke Dimensi yang Tepat — Gratis & Akurat"
description: "Cara resize foto online dengan presisi pixel — ubah dimensi foto ke ukuran yang dibutuhkan tanpa install aplikasi, langsung di browser, gratis."
category: "tips"
...
|---|---|---|---|
| Instagram | 320×320 px | 1080×1080 px (square) | Feed terbaik di 1:1 |
| Facebook | 170×170 px | 1200×630 px | Cover: 820×312 px |
| LinkedIn | 400×400 px | 1200×627 px | Profil: foto wajah jelas |
...
1. **Buka tool** di `/tools/image-resizer` — tidak perlu login
2. **Upload foto** — drag & drop atau klik untuk pilih dari perangkat
3. **Lihat dimensi asli** — tool menampilkan ukuran foto saat ini (lebar × tinggi px)
4. **Masukkan dimensi target** — ketik lebar dan/atau tinggi yang diinginkan dalam pixel
5. **Pilih mode resize**:
...
6. **Preview** — lihat foto setelah resize
7. **Download** — simpan hasil dengan nama otomatis yang mencantumkan dimensi baru
...
Gunakan [tool crop foto](/article/tips/cara-crop-foto-online-gratis) untuk crop terlebih dahulu sebelum resize jika aspect ratio foto tidak sesuai dengan target.
...
1. Resize ke dimensi target terlebih dahulu
2. Lalu [kompres foto](/article/tips/cara-kompres-foto-tanpa-kehilangan-kualitas) untuk mengoptimalkan ukuran file
